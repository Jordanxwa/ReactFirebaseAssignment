For this assignment I created a Chat Bot that you can anonymously use to message anybody who uses this app. Thu user messages and user names are stored in the real time data base through Firebase.
